...
4. **Scratch-offs** table: game, pack, price, start#→end#, sold, dollars, by, verified-by; totals row. *(Since PR #220 the line-by-line print covers cash + backroom only — scratch detail prints from the owner Scratch report instead.)*
